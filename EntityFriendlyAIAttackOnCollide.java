...
public class EntityFriendlyAIAttackOnCollide extends EntityAIBase
{
    World worldObj;
    ...
    public EntityFriendlyAIAttackOnCollide(IFriendAble par1EntityLiving, Class par2Class, float par3, boolean par4)
    {
        this(par1EntityLiving, par3, par4);
        this.classTarget = par2Class;
    }

    public EntityFriendlyAIAttackOnCollide(IFriendAble par1EntityLiving, float par2, boolean par3)
    {
        this.attackTick = 0;
        this.attacker = (EntityLiving)par1EntityLiving;
        this.worldObj = par1EntityLiving.getWorld();
