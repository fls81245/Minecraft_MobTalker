...
public class EntityFriendlySkeleton extends EntityFriendlyMob implements IRangedAttackMob
{
    ...
    public EntityFriendlySkeleton(World par1World)
    {
        super(par1World);
        ...
        tasks.addTask(5, new EntityFriendlyAIFollowPlayer(this, moveSpeed, 10F, 2.0F));
        tasks.addTask(6, new EntityAIWander(this, moveSpeed));
        tasks.addTask(7, new EntityAIWatchClosest(this, net.minecraft.src.EntityPlayer.class, 8F));
        tasks.addTask(7, new EntityAILookIdle(this));
        targetTasks.addTask(1, new EntityAIHurtByTarget(this, false));
        targetTasks.addTask(2, new EntityFriendlyAINearestAttackableTarget(this, net.minecraft.src.EntityPlayer.class, 16F, 0, true));
