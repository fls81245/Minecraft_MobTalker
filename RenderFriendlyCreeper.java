...
public class RenderFriendlyCreeper extends RenderLiving
{
     ...
     */
    protected void updateCreeperScale(EntityFriendlyCreeper par1EntityFriendlyCreeper, float par2)
    {
        EntityFriendlyCreeper EntityFriendlyCreeper = par1EntityFriendlyCreeper;
        float f = EntityFriendlyCreeper.setCreeperFlashTime(par2);
     ...
     */
    protected int updateCreeperColorMultiplier(EntityFriendlyCreeper par1EntityFriendlyCreeper, float par2, float par3)
    {
        EntityFriendlyCreeper EntityFriendlyCreeper = par1EntityFriendlyCreeper;
        float f = EntityFriendlyCreeper.setCreeperFlashTime(par3);
    ...
    protected int func_27006_a(EntityFriendlyCreeper par1EntityFriendlyCreeper, int par2, float par3)
    {
        if (par1EntityFriendlyCreeper.getPowered())
        {
            if (par2 == 1)
            {
                float f = (float)par1EntityFriendlyCreeper.ticksExisted + par3;
    ...
    protected int func_27007_b(EntityFriendlyCreeper par1EntityFriendlyCreeper, int par2, float par3)
    {
        return -1;
    }
